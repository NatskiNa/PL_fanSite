const directory = [
  ...
  {
    question:
      'In soccer, how many players are on the field for each team during a regulation match?',
    answers: ['8', '11', '10'],
    correctAnswer: '11',
  },
  {
    question:
      'What is the term for a situation in which one player scores three goals in a single game?',
    answers: ['Hat-trick', 'Touchdown', 'Slam dunk'],
    correctAnswer: 'Hat-trick',
  },
  {
    question:
      'Which country won the 2020 UEFA European Championship (Euro 2020), which was held in 2021 due to the COVID-19 pandemic?',
...
startButton.addEventListener('click', function () {
  let count = 1,
    i = 0,
    correct = 0,
    totalQuestion = directory.length;
